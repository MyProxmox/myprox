...
const translations = {
  fr: {
    ...
    settings_servers_local: 'Serveurs locaux',
    settings_servers_used: 'Total serveurs',
  ...
  en: {
    ...
    settings_servers_local: 'Local servers',
    settings_servers_used: 'Total servers',
  ...
  es: {
    ...
    settings_servers_local: 'Servidores locales',
    settings_servers_used: 'Total servidores',
